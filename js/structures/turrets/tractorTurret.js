TractorTurret.prototype = new Structure();
TractorTurret.prototype.constructor = TractorTurret;

function TractorTurret(x, y)
{
	this.m_iType = 6666;
	...
	// Construction
	this.m_iMetalRequired = 500;
	
	// Local Variables	
	var _cannons = new Array();
	var _cannon1 = new Tractor(this, 0, 0, 0, Math.PI * 2);
...
TractorTurret.prototype.update = function()
{	
	// Call base update
...
TractorTurret.prototype.draw = function()
{	
...
TractorTurret.prototype.onFire = function()
{	
	// REDUNDANT FUNCTION!
...
TractorTurret.prototype.setTargets = function()
{
