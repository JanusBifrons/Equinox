...
function Control(x, y, team, sector)
{
	...
	GameObject.prototype.initializeStats.call(this, 1000, 60, 5000, 1000, 30000, 1000);
...
{	
	...
	if(this.m_iMetalStored < this.m_iMetalStoredMax)
	{
		...
		// Get some metal!
		if(Structure.prototype.onRequest.call(this, new Request(this, 1, _drain)))
		{	
			this.m_iMetalStored += _drain;
		}	
	}	
}
