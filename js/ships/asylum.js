...
function Asylum(x, y, moveX, moveY, owner)
{	
	this.m_kOwner = owner;
	...
	var _beam1 = new LightBeam(this, 0, -12, 0, 0);
	var _beam2 = new LightBeam(this, 0, 12, 0, 0);
	_beams.push(_beam1);
	_beams.push(_beam2);
...
Asylum.prototype.drawShield = function(shieldPercent)
{
...
Asylum.prototype.drawShip = function()
{
	// Draw Ship
...
Asylum.prototype.drawFlame = function()
{
