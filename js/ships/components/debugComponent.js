DebugComponent.prototype = new ShipComponent();
DebugComponent.prototype.constructor = DebugComponent;

function DebugComponent(owner, offsetX, offsetY, scale)
{
	this.m_kOwner = owner;
...
DebugComponent.prototype.update = function()
{
	// Call base update
...
DebugComponent.prototype.draw = function()
{
	// Call base update
...
DebugComponent.prototype.createPoints = function()
{
	// Collision Detection
	...
	ShipComponent.prototype.calculateCenter.call(this);
	
	ShipComponent.prototype.adjustCenter.call(this);
}