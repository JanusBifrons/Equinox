RightPad.prototype = new ShipComponent();
RightPad.prototype.constructor = RightPad;

function RightPad(owner, offsetX, offsetY, scale)
{
	// Call base initialize
	ShipComponent.prototype.initialize.call(this, owner, offsetX, offsetY, scale);
}

RightPad.prototype.update = function()
{
	// Call base update
	ShipComponent.prototype.update.call(this);
}

RightPad.prototype.draw = function()
{
	// Call base draw
...
RightPad.prototype.createPoints = function()
{
	// Collision Detection
