ExtractorBeam.prototype = new Beam();
ExtractorBeam.prototype.constructor = ExtractorBeam;

function ExtractorBeam(owner, offsetX, offsetY, minRot, maxRot)
{
	this.m_sDescription = "Extractor Beam";
	...
	console.log("Extractor Beam initialised successfully.");
}

ExtractorBeam.prototype.update = function()
{
	// Call base update
	Beam.prototype.update.call(this);
}

ExtractorBeam.prototype.draw = function()
{	
	// Call base draw
...
ExtractorBeam.prototype.onHit = function(targetHit)
{	
	//m_kLog.addItem("HIT!", 100, 255, 255, 255);

	this.m_kOwner.onCollectMetal((2 / 1000) * m_fElapsedTime);
}